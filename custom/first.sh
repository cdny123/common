#!/bin/bash
# https://github.com/28677160/build-actions
...
if [[ -n "${BENDI_VERSION}" ]]; then
  ...
  sudo rm -rf build/common && git clone -b main --depth 1 https://github.com/cdny123/common build/common
...
git clone -b main --depth 1 https://github.com/cdny123/build-actions shangyou
...
if [[ "${GIT_REPOSITORY}" =~ (cdny123/build-actions|cdny123/autobuild) ]]; then
  rm -rf backups
...
curl -fsSL https://raw.githubusercontent.com/cdny123/common/main/common.sh -o common.sh
if [[ $? -ne 0 ]]; then
  wget -q https://raw.githubusercontent.com/cdny123/common/main/common.sh -O common.sh
fi
...
if [[ -n "${BENDI_VERSION}" ]]; then
  ...
  export GIT_REPOSITORY="cdny123/build-actions"
  sudo rm -rf build common.sh
